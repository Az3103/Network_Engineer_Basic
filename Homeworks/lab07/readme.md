...
4. Проверим работу протокола STP, исходя из приоритета портов:


Включим порты 1 и 3 на всех коммутаторах:

```
interface range f 0/1, f 0/3
no shutdown
```

Теперь проверим результат на некорневых коммутаторах:
